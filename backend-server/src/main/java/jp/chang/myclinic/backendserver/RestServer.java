...
public class RestServer {
  ...
  @Inject
  RestServer(DbBackend dbBackend, SupportSet ss) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<PatientDTO> searchPatientByKeyword2(
      @QueryParam("last-name-keyword") String lastNameKeyword,
      @QueryParam("first-name-keyword") String firstNameKeyword) {
    return dbBackend.query(
        backend -> backend.searchPatientByKeyword2(lastNameKeyword, firstNameKeyword));
  }
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<VisitPatientDTO> listRecentVisitWithPatient(
      @QueryParam("page") int page, @QueryParam("items-per-page") int itemsPerPage) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public VisitFull2PageDTO listVisitFull2(
      @QueryParam("patient-id") int patientId, @QueryParam("page") int page) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public HokenDTO listAvailableHoken(
      @QueryParam("patient-id") int patientId, @QueryParam("visited-at") LocalDate visitedAt) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<Integer> listRepresentativeGaiyouDrugId(
      @QueryParam("text") String text, @QueryParam("patient-id") int patientId) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<DrugFullDTO> searchPrevDrug(
      @QueryParam("text") String text, @QueryParam("patient-id") int patientId) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public TextVisitPageDTO searchText(
      @QueryParam("patient-id") int patientId,
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public TextVisitPatientPageDTO searchTextGlobally(
      @QueryParam("text") String text, @QueryParam("page") int page) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public ShinryouFullWithAttrDTO getShinryouFullWithAttr(
      @QueryParam("shinryou-id") int shinryouId) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<ShinryouFullWithAttrDTO> listShinryouFullWithAttr(
      @QueryParam("visit-id") int visitId) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @POST
  public void modifyConductKind(
      @QueryParam("conduct-id") int conductId, @QueryParam("conduct-kind") int conductKind) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public ConductShinryouDTO getConductShinryou(
      @QueryParam("conduct-shinryou-id") int conductShinryouId) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public ConductShinryouFullDTO getConductShinryouFull(
      @QueryParam("conduct-shinryou-id") int conductShinryouId) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<ConductShinryouFullDTO> listConductShinryouFull(
      @QueryParam("conduct-id") int conductId) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public ConductKizaiFullDTO getConductKizaiFull(
      @QueryParam("conduct-kizai-id") int conductKizaiId) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<ShahokokuhoDTO> findAvailableShahokokuho(
      @QueryParam("patient-id") int patientId, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<KoukikoureiDTO> findAvailableKoukikourei(
      @QueryParam("patient-id") int patientId, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<RoujinDTO> findAvailableRoujin(
      @QueryParam("patient-id") int patientId, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<KouhiDTO> findAvailableKouhi(
      @QueryParam("patient-id") int patientId, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public ShinryouMasterDTO findShinryouMasterByName(
      @QueryParam("name") String name, @QueryParam("at") LocalDate at) {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @POST
  public ShinryouMasterDTO resolveShinryouMasterByName(
      List<String> nameCandidates, @QueryParam("at") LocalDate at) {
  ...
  public Map<String, Integer> batchResolveShinryouNames(
      List<List<String>> args, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<ShinryouMasterDTO> searchShinryouMaster(
      @QueryParam("text") String text, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public ShinryouMasterDTO getShinryouMaster(
      @QueryParam("shinryoucode") int shinryoucode, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public IyakuhinMasterDTO getIyakuhinMaster(
      @QueryParam("iyakuhincode") int iyakuhincode, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<IyakuhinMasterDTO> searchIyakuhinMaster(
      @QueryParam("text") String text, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public KizaiMasterDTO getKizaiMaster(
      @QueryParam("kizaicode") int kizaicode, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public KizaiMasterDTO findKizaiMasterByName(
      @QueryParam("name") String name, @QueryParam("at") LocalDate at) {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @POST
  public KizaiMasterDTO resolveKizaiMasterByName(
      List<String> nameCandidates, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<KizaiMasterDTO> searchKizaiMaster(
      @QueryParam("text") String text, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<ByoumeiMasterDTO> searchByoumeiMaster(
      @QueryParam("text") String text, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public ByoumeiMasterDTO getByoumeiMasterByName(
      @QueryParam("name") String name, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public List<ShuushokugoMasterDTO> searchShuushokugoMaster(
      @QueryParam("text") String text, @QueryParam("at") LocalDate at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public VisitDTO startVisit(
      @QueryParam("patient-id") int patientId, @QueryParam("at") LocalDateTime at) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public DrugAttrDTO setDrugTekiyou(
      @QueryParam("drug-id") int drugId, @QueryParam("tekiyou") String tekiyou) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public void setGazouLabel(
      @QueryParam("conduct-id") int conductId, @QueryParam("label") String label) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public ShinryouMasterDTO resolveShinryouMasterByKey(
      @QueryParam("key") String key, @QueryParam("at") LocalDate at) {
    return supportService.resolveShinryouMasterByKey(key, at);
  }

  @Path("resolve-kizai-master-by-key")
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public KizaiMasterDTO resolveKizaiMasterByKey(
      @QueryParam("key") String key, @QueryParam("at") LocalDate at) {
    return supportService.resolveKizaiMasterByKey(key, at);
  }
  ...
  @POST
  @Consumes(MediaType.APPLICATION_JSON)
  public BatchEnterResultDTO batchEnterByNames(
      @QueryParam("visit-id") int visitId, BatchEnterByNamesRequestDTO req) {
    return supportService.batchEnterByNames(visitId, req);
  }
  ...
  public List<DiseaseExampleDTO> listDiseaseExample() {
    return supportService.listDiseaseExample();
  }
  ...
  public MeisaiDTO getMeisai(@QueryParam("visit-id") int visitId) {
    return supportService.getMeisai(visitId);
  }

  @Path("resolve-stock-drug")
  @Produces(MediaType.APPLICATION_JSON)
  @GET
  public IyakuhinMasterDTO resolveStockDrug(
      @QueryParam("iyakuhincode") int iyakuhincode, @QueryParam("at") LocalDate at) {
    return supportService.resolveStockDrug(iyakuhincode, at);
  }
  ...
  @POST
  @Consumes(MediaType.APPLICATION_JSON)
  public List<ResolvedStockDrugDTO> batchResolveStockDrug(
      List<Integer> iyakuhincodes, @QueryParam("at") LocalDate at) {
    return supportService.batchResolveStockDrug(iyakuhincodes, at);
  }

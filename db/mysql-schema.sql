...
) ENGINE=InnoDB AUTO_INCREMENT=59162 DEFAULT CHARSET=cp932;
...
) ENGINE=InnoDB AUTO_INCREMENT=9373 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10711 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=217092 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1333 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7086 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=77345 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=875 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=94736 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_conduct` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1174 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_conduct_drug` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=441 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_conduct_kizai` (
  ...
  `amount` double NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=757 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_conduct_shinryou` (
  ...
  `shinryoucode` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1743 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_drug` (
  ...
  PRIMARY KEY (`drug_id`),
  KEY `visit_id` (`visit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=179275 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_shinryou` (
  ...
  PRIMARY KEY (`shinryou_id`),
  KEY `visit_id` (`visit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=628234 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_text` (
  ...
  PRIMARY KEY (`text_id`),
  KEY `visit_id` (`visit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=116085 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-12-16 11:36:32

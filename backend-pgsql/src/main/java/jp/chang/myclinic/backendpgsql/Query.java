...
public class Query {
    ...
    public static void setConnectionProvider(Supplier<Connection> provider){
        Query.connectionProvider = provider;
    }
    ...
    public static void exec(String sql, SqlConsumer<PreparedStatement> paramSetter) {
        try {
    ...
    public static int update(String sql, SqlConsumer<PreparedStatement> setter) {
        try {
            PreparedStatement stmt = getConnection().prepareStatement(sql);
            setter.accept(stmt);
    ...
    public static int update(String sql, int autoGeneratedKeys, SqlConsumer<ResultSet> mapper,
    ...
    public static <T> T get(String sql, Projector<T> projector,
    ...
    public static <T> List<T> query(String sql, Projector<T> projector,
    ...
    public static <T> List<T> query(String sql, Projector<T> projector, Object... params) {
        try {
            PreparedStatement stmt = getConnection().prepareStatement(sql);
            int index = 1;
            for (Object param : params) {

...
public interface Frontend {
    ...
    CompletableFuture<Void> enterPatient(PatientDTO patient);
    ...
    CompletableFuture<Void> enterConduct(ConductDTO conduct);
    ...
    CompletableFuture<Void> enterConductShinryou(ConductShinryouDTO shinryou);
    ...
    CompletableFuture<Void> enterConductDrug(ConductDrugDTO drug);
    ...
    CompletableFuture<Void> enterConductKizai(ConductKizaiDTO kizai);
    ...
    CompletableFuture<Void> enterDisease(DiseaseDTO disease);
    ...
    CompletableFuture<Void> enterPrescExample(PrescExampleDTO prescExample);
